...
wget -O src/xampp-linux-x64-8.0.8-0-installer.run https://www.apachefriends.org/xampp-files/8.0.8/xampp-linux-x64-8.0.8-0-installer.run
chmod +x src/xampp-linux-x64-8.0.8-0-installer.run
./src/xampp-linux-x64-8.0.8-0-installer.run
